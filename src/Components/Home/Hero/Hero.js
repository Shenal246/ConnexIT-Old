    ...
    <section id="hero" className="section hero">
      <div className="container">
        <div className="row gy-4">
          <div className="col-lg-8 order-2 order-lg-1 d-flex flex-column justify-content-center cont" data-aos="fade-down" data-aos-duration="1000">
          ...
          <div className="col-lg-4 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-duration="1000">
