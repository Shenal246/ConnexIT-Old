        ...
        <div className="container">
            ...
            <div className="row cards">  
                <div className="col-lg-4 ">
                    <div className="card mb-3 card1 text-light position-relative crd">
                        <div className="position-relative">
                            <img src={card1} className="card-img-top image" alt="ConnexIT Logo" style={{ width: '100%', height: 'auto' }} /> {/* Adjusted image size */}
                        ...
                        <div className="card-body card1 rounded">
                            <div className="row">  
                ...
                <div className="col-lg-4 ">
                    <div className="card mb-3 card1 text-light position-relative crd">
                        <div className="position-relative">
                            ...
                            {/* Position the Link component at the center of the image */}
                            <div className="centered">
                                <Link to="http://localhost:3000/" className="fa-solid fa-play playicon"></Link> {/* Changed span to Link and added z-index */}
                            </div>
                        </div>
                        <div className="card-body card1 rounded">
                            <div className="row">  
