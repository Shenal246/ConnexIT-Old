...
const Contact = () => {
    ...
    return (
        <div className="container">
            <div className='row'>
                <div className="row gy-3 text mb-4" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="100">
            ...
            <div className="row">
                <div className="col-md-6 inputField" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">
                ...
                <div className="col-md-6 inputField" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="100">
                    {/* map */}
